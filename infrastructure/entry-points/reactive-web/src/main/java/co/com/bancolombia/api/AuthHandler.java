...
public class AuthHandler {
    ...
    public AuthHandler(UserRepository userRepository, JwtProvider jwtProvider, PasswordEncoderGateway passwordEncoderGateway) {
                                ...
                                .flatMap(user -> {
                                    if (passwordEncoderGateway.matches(loginRequest.password(), user.getPassword())) {
                                        ...
                                        return ServerResponse.ok()
                                                ...
                                                .bodyValue(new LoginDTO.LoginResponse(token));
                                    } else {
